# Contributing
The following is a set of general guidelines for contributing to `TRANZACT` projects.
First consult the project's README.md to see if there are any contributing guidelines or links.  

## Code of Conduct
This project is governed by the `TRANZACT` Organization's [Code of Conduct](./CODE_OF_CONDUCT.md).  By participating you are expected to uphold this code.    
